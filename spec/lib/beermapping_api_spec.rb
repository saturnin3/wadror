...
describe "BeermappingApi" do
  describe "in case of cache miss" do
    ...
    it "When HTTP GET returns several entries, all are parsed and returned" do
      ...
      place2 = places.last
      expect(place2.name).to eq("Teerenpeli")
      expect(place2.street).to eq("Liimaajankatu 9")
    end
  end #end describing in case of cache miss
